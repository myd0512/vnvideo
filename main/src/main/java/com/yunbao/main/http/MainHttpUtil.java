...
import com.yunbao.common.http.HttpNoRSAClient;
...
public class MainHttpUtil {
    ...
    public static void loginByThird(String openid, String nicename, String avatar, String type, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Login.userLoginByThird", MainHttpConsts.LOGIN_BY_THIRD)
    ...
    public static void getLoginInfo(HttpCallback callback) {
        HttpClient.getInstance().post("Home.getLogin", MainHttpConsts.GET_LOGIN_INFO)
                .execute(callback);
    }
    ...
    public static void updatePushId(String pushId) {
        HttpClient.getInstance().post("Login.upUserPush", "updatePushId")
    ...
    public static void requestBonus(HttpCallback callback) {
        HttpClient.getInstance().post("User.Bonus", MainHttpConsts.REQUEST_BONUS)
                .params("uid", CommonAppConfig.getInstance().getUid())
    ...
    public static void getBonus(HttpCallback callback) {
        HttpClient.getInstance().post("User.getBonus", MainHttpConsts.GET_BONUS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void setDistribut(String code, HttpCallback callback) {
        HttpClient.getInstance().post("User.setDistribut", MainHttpConsts.SET_DISTRIBUT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("code", code)
                .execute(callback);
    ...
    public static void getHot(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.getHot", MainHttpConsts.GET_HOT)
                .params("p", p)
                .execute(callback);
    }
    ...
    public static void getFollow(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.getFollow", MainHttpConsts.GET_FOLLOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("p", p)
                .execute(callback);
    }
    ...
    public static void getNear(int p, HttpCallback callback) {
        HttpNoRSAClient.getInstance().post("Home.getNearby", MainHttpConsts.GET_NEAR)
    ...
    public static void profitList(String type, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.profitList", MainHttpConsts.PROFIT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("type", type)
                .params("p", p)
                .execute(callback);
    ...
    public static void consumeList(String type, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.consumeList", MainHttpConsts.CONSUME_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("type", type)
                .params("p", p)
                .execute(callback);
    ...
    public static void getBaseInfo(String uid, String token, final CommonCallback<UserBean> commonCallback) {
        HttpClient.getInstance().post("User.getBaseInfo", MainHttpConsts.GET_BASE_INFO)
                .params("uid", uid)
                .params("token", token)
...
//                            LogUtil.elong("ja->",info[0]);
                            //Log.e("getBaseInfo->>>",info[0]);
    ...
    public static void getUserHome(String touid, HttpCallback callback) {
        HttpClient.getInstance().post("User.getUserHome", MainHttpConsts.GET_USER_HOME)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .execute(callback);
    }
    ...
    public static void setBlack(String toUid, HttpCallback callback) {
        HttpClient.getInstance().post("User.setBlack", MainHttpConsts.SET_BLACK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", toUid)
                .execute(callback);
    ...
    public static void getSettingList(HttpCallback callback) {
        HttpClient.getInstance().post("User.getPerSetting", MainHttpConsts.GET_SETTING_LIST)
                .execute(callback);
    }
    ...
    public static void search(String key, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.search", MainHttpConsts.SEARCH)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("key", key)
                .params("p", p)
                .execute(callback);
    ...
    public static void updateAvatar(File file, HttpCallback callback) {
        ...
        params.put("uid", CommonAppConfig.getInstance().getUid());
        params.put("token", CommonAppConfig.getInstance().getToken());
...
//                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void updateFields(String fields, HttpCallback callback) {
        HttpClient.getInstance().post("User.updateFields", MainHttpConsts.UPDATE_FIELDS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getProfit(HttpCallback callback) {
        HttpClient.getInstance().post("User.getProfit", MainHttpConsts.GET_PROFIT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getCashAccountList(HttpCallback callback) {
        HttpClient.getInstance().post("User.GetUserAccountList", MainHttpConsts.GET_USER_ACCOUNT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void addCashAccount(String account, String name, String bank, int type, HttpCallback callback) {
        HttpClient.getInstance().post("User.SetUserAccount", MainHttpConsts.ADD_CASH_ACCOUNT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void deleteCashAccount(String accountId, HttpCallback callback) {
        HttpClient.getInstance().post("User.delUserAccount", MainHttpConsts.DEL_CASH_ACCOUNT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", accountId)
                .execute(callback);
    ...
    public static void doCash(String votes, String accountId, HttpCallback callback) {
        HttpClient.getInstance().post("User.setCash", MainHttpConsts.DO_CASH)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getClassLive(int classId, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Home.getClassLive", MainHttpConsts.GET_CLASS_LIVE)
    ...
    public static void getMyImpress(HttpCallback callback) {
        HttpClient.getInstance().post("User.GetMyLabel", MainHttpConsts.GET_MY_IMPRESS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getRecommend(HttpCallback callback) {
        HttpClient.getInstance().post("Home.getRecommend", MainHttpConsts.GET_RECOMMEND)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void recommendFollow(String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Home.attentRecommend", MainHttpConsts.RECOMMEND_FOLLOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .execute(callback);
    }
    ...
    public static void getRegisterCode(String mobile, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Login.getCode", MainHttpConsts.GET_REGISTER_CODE)
    ...
    public static void register(String user_login, String pass, String pass2, String code, HttpCallback callback) {
        HttpClient.getInstance().post("Login.userReg", MainHttpConsts.REGISTER)
    ...
    public static void findPwd(String user_login, String pass, String pass2, String code, HttpCallback callback) {
        HttpClient.getInstance().post("Login.userFindPass", MainHttpConsts.FIND_PWD)
                .params("user_login", user_login)
                .params("user_pass", pass)
                .params("user_pass2", pass2)
                .params("code", code)
    ...
    public static void modifyPwd(String oldpass, String pass, String pass2, HttpCallback callback) {
        HttpClient.getInstance().post("User.updatePass", MainHttpConsts.MODIFY_PWD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getFindPwdCode(String mobile, HttpCallback callback) {
        String sign = MD5Util.getMD5("mobile=" + mobile + "&" + SALT);
        HttpClient.getInstance().post("Login.getForgetCode", MainHttpConsts.GET_FIND_PWD_CODE)
                .params("mobile", mobile)
                .params("sign", sign)
                .execute(callback);
    }
    ...
    public static void getQrCode(HttpCallback callback) {
        HttpClient.getInstance().post("Agent.getCode", MainHttpConsts.GET_QR_CODE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getShop(int p, String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.GetShop", MainHttpConsts.GET_SHOP)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .params("touid", touid)
    ...
    public static void getShopInfo(String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getShopInfo", MainHttpConsts.GET_SHOP_INFO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
                .execute(callback);
    ...
    public static void setGoods(int type, GoodsBean goodsBean, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.SetGoods", MainHttpConsts.SET_GOODS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("type", type)
...
//                .params("old_price", goodsBean.getPriceOrigin())
    ...
    public static void getRecommentGoods(String touid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.GetRecomment", MainHttpConsts.GET_RECOMMENT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
                .params("p", p)
    ...
    public static void upGoodsStatus(String goodsid, int status, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.UpStatus", MainHttpConsts.SHOP_UPSTATUS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void delGoods(String goodsid, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.DelGoods", MainHttpConsts.SHOP_UPSTATUS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("goodsid", goodsid)
                .execute(callback);
    ...
    public static void getApplets(String goodsid, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.GetApplets", MainHttpConsts.GET_APPLETS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", goodsid)
                .execute(callback);
    ...
    public static void activePublish(
        ...
        HttpClient.getInstance().post("Dynamic.setDynamic", MainHttpConsts.ACTIVE_PUBLISH)
                .params("uid", uid)
    ...
    public static void getActiveHome(String touid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getHomeDynamic", MainHttpConsts.GET_HOME_ACTIVE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
                .params("p", p)
    ...
    public static void getActiveRecommend(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getRecommendDynamics", MainHttpConsts.GET_ACTIVE_RECOMMEND)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void getActiveFollow(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getAttentionDynamic", MainHttpConsts.GET_ACTIVE_FOLLOW)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void getActiveNewest(int p, HttpCallback callback) {
        CommonAppConfig appConfig = CommonAppConfig.getInstance();
        HttpClient.getInstance().post("Dynamic.getNewDynamic", MainHttpConsts.GET_ACTIVE_NEWEST)
    ...
    public static void activeAddLike(String activeId, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Dynamic.addLike", MainHttpConsts.ACTIVE_ADD_LIKE)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getActiveReportList(HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getReportlist", MainHttpConsts.GET_ACTIVE_REPORT_LIST)
                .execute(callback);
    }
    ...
    public static void activeReport(String activeId, String content, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.report", MainHttpConsts.ACTIVE_REPORT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("dynamicid", activeId)
    ...
    public static void activeDelete(String activeId, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.del", MainHttpConsts.ACTIVE_DELETE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("dynamicid", activeId)
                .execute(callback);
    ...
    public static void activeComment(String activeId, String toUid, String commentId, String parentId, String content, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.setComment", MainHttpConsts.ACTIVE_COMMENT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("dynamicid", activeId)
                .params("touid", toUid)
    ...
    public static void getActiveComments(String activeId, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getComments", MainHttpConsts.GET_ACTIVE_COMMENTS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("dynamicid", activeId)
                .params("p", p)
    ...
    public static void setActiveCommentLike(String commentId, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Dynamic.addCommentLike", MainHttpConsts.SET_ACTIVE_COMMENT_LIKE)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("commentid", commentId)
                .params("sign", sign)
    ...
    public static void getActiveCommentReply(String commentid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Dynamic.getReplys", MainHttpConsts.GET_ACTIVE_COMMENT_REPLY)
                .params("commentid", commentid)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
     ...
     * 获取分享getcode
     */
    public static void getShareCode( HttpCallback callback) {
        HttpClient.getInstance().post("Agent.GetCode", "Agent.GetCode")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 获取分享getmsg
     */
    public static void getShare( HttpCallback callback) {
        HttpClient.getInstance().post("Agent.GetShare", "Agent.GetShare")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
