...
public class MallHttpUtil {
    ...
    public static void getBuyerHome(HttpCallback callback) {
        HttpClient.getInstance().post("Buyer.getHome", MallHttpConsts.GET_BUYER_HOME)
    ...
    public static void getBuyerAddress(HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Buyer.addressList", MallHttpConsts.GET_BUYER_ADDRESS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerAddAddress(
        ...
        HttpClient.getInstance().post("Buyer.addAddress", MallHttpConsts.BUYER_ADD_ADDRESS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerModifyAddress(
        ...
        HttpClient.getInstance().post("Buyer.editAddress", MallHttpConsts.BUYER_MODIFY_ADDRESS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerDeleteAddress(String addressId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("addressid=", addressId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.delAddress", MallHttpConsts.BUYER_DELETE_ADDRESS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerAddBrowseRecord(String goodsId) {
        ...
        HttpClient.getInstance().post("Buyer.addGoodsVisitRecord", MallHttpConsts.BUYER_ADD_BROWSE_RECORD)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerDeleteBrowseRecord(String recordId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.delGoodsVisitRecord", MallHttpConsts.BUYER_DELETE_BROWSE_RECORD)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerGoodsRecord(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Buyer.getGoodsVisitRecord", MallHttpConsts.GET_BUYER_GOODS_RECORD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void buyerCreateOrder(
        ...
        HttpClient.getInstance().post("Buyer.createGoodsOrder", MallHttpConsts.BUYER_CREATE_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerPayList(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.getBalance", MallHttpConsts.GET_BUYER_PAY_LIST)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerPayOrder(String orderId, String payType, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Buyer.goodsOrderPay", MallHttpConsts.BUYER_PAY_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerOrderList(String type, int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.getGoodsOrderList", MallHttpConsts.GET_BUYER_ORDER_LIST)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerDeleteOrder(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.delGoodsOrder", MallHttpConsts.BUYER_DELETE_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerCancelOrder(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.cancelGoodsOrder", MallHttpConsts.BUYER_CANCEL_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerConfirmReceive(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.receiveGoodsOrder", MallHttpConsts.BUYER_CONFIRM_RECEIVE)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerOrderDetail(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.getGoodsOrderInfo", MallHttpConsts.GET_BUYER_ORDER_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerSetComment(
        ...
        HttpClient.getInstance().post("Buyer.evaluateGoodsOrder", MallHttpConsts.BUYER_SET_COMMENT)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerAppendComment(
        ...
        HttpClient.getInstance().post("Buyer.appendEvaluateGoodsOrder", MallHttpConsts.BUYER_APPEND_COMMENT)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getRefundReasonList(HttpCallback callback) {
        HttpClient.getInstance().post("Buyer.getRefundReason", MallHttpConsts.GET_REFUND_REASON_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void buyerApplyRefund(
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.applyRefundGoodsOrder", MallHttpConsts.BUYER_APPLY_REFUND)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerRefundDetail(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.getGoodsOrderRefundInfo", MallHttpConsts.GET_BUYER_REFUND_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerCancelRefund(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.cancelRefundGoodsOrder", MallHttpConsts.BUYER_CANCEL_REFUND)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getOfficialRefundReason(HttpCallback callback) {
        HttpClient.getInstance().post("Buyer.getPlatformReasonList", MallHttpConsts.GET_OFFICIAL_REFUND_REASON)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void buyerApplyRefundAgain(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.reapplyRefundGoodsOrder", MallHttpConsts.BUYER_APPLY_REFUND_AGAIN)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void buyerApplyOfficialRefund(String orderId, String reasonId, String content, String thumb, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Buyer.applyPlatformInterpose", MallHttpConsts.BUYER_APPLY_OFFICIAL_REFUND)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyerAccountInfo(int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Buyer.getRefundList", MallHttpConsts.GET_BUYER_ACCOUNT_INFO)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getShopHome(String toUid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getShop", MallHttpConsts.GET_SHOP_HOME)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", toUid)
                .params("p", p)
    ...
    public static void getManageClass(HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getOneGoodsClass", MallHttpConsts.GET_MANAGE_CLASS)
                .execute(callback);
    }
    ...
    public static void setBond(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Shop.deductBond", MallHttpConsts.SET_BOND)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBondStatus(HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getBond", MallHttpConsts.GET_MANAGE_CLASS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void applyShop(
            ...
            String otherFileUrl,
            HttpCallback callback) {
        HttpClient.getInstance().post("Shop.shopApply", MallHttpConsts.APPLY_SHOP)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("username", name)
    ...
    public static void getShopApplyInfo(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Shop.getShopApplyInfo", MallHttpConsts.GET_SHOP_APPLY_INFO)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getSellerHome(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.getHome", MallHttpConsts.GET_SELLER_HOME)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getGoodsClass(HttpCallback callback) {
        HttpClient.getInstance().post("Seller.getGoodsClass", MallHttpConsts.GET_GOODS_CLASS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void setGoods(
            ...
            String goodsId,
            HttpCallback callback) {
        HttpClient.getInstance().post(TextUtils.isEmpty(goodsId) ? "Seller.setGoods" : "Seller.upgoods", MallHttpConsts.SET_GOODS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getManageGoodsList(String type, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Seller.getGoodsList", MallHttpConsts.GET_MANAGE_GOODS_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("type", type)
                .params("p", p)
    ...
    public static void getGoodsInfo(String goodsId, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getGoodsInfo", MallHttpConsts.GET_GOODS_INFO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("goodsid", goodsId)
                .execute(callback);
    ...
    public static void getGoodsNum(HttpCallback callback) {
        HttpClient.getInstance().post("Seller.getGoodsNums", MallHttpConsts.GET_GOODS_NUM)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void goodsDelete(String goodsId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.delGoods", MallHttpConsts.GOODS_DELETE)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void goodsUpStatus(String goodsId, int status, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("goodsid=", goodsId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.upStatus", MallHttpConsts.GOODS_UP_STATUS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void goodsModifySpec(String goodsId, String specs, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.upGoodsSpecs", MallHttpConsts.GOODS_MODIFY_SPEC)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getRefundAddress(HttpCallback callback) {
        HttpClient.getInstance().post("Seller.getReceiverAddress", MallHttpConsts.GET_REFUND_ADDRESS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void modifyRefundAddress(
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.upReceiverAddress", MallHttpConsts.MODIFY_REFUND_ADDRESS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getSellerOrderList(String type, int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.getGoodsOrderList", MallHttpConsts.GET_SELLER_ORDER_LIST)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getSellerOrderDetail(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.getGoodsOrderInfo", MallHttpConsts.GET_SELLER_ORDER_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getWuliuList(HttpCallback callback) {
        HttpClient.getInstance().post("seller.getExpressList", MallHttpConsts.GET_WULIU_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void sellerSendOrder(String orderId, String wuliuId, String wuliuOrderNum, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Seller.setExpressInfo", MallHttpConsts.SELLER_SEND_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void sellerDeleteOrder(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.delGoodsOrder", MallHttpConsts.SELLER_DELETE_ORDER)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getSellerRefundDetail(String orderId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.getGoodsOrderRefundInfo", MallHttpConsts.GET_SELLER_REFUND_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getRejectRefundReason(HttpCallback callback) {
        HttpClient.getInstance().post("Seller.getRefundRefuseReason", MallHttpConsts.GET_REJECT_REFUND_REASON)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void sellerSetRefund(String orderId, int type, String reasonId, String content, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("orderid=", orderId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("seller.setGoodsOrderRefund", MallHttpConsts.SELLER_SET_REFUND)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getGoodsCommentList(String goodsId, String type, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.getGoodsCommentList", MallHttpConsts.GET_GOODS_COMMENT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("goodsid", goodsId)
                .params("type", type)
    ...
    public static void getSellerAccountInfo(int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Seller.getSettlementList", MallHttpConsts.GET_SELLER_ACCOUNT_INFO)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void goodsCash(String accountId, String money, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("User.setShopCash", MallHttpConsts.GOODS_CASH)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getPayApplyStatus(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.getApplyStatus", MallHttpConsts.GET_PAY_APPLY_STATUS)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void applyPayOpen(HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.apply", MallHttpConsts.APPLY_PAY_OPEN)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getPayClassList(HttpCallback callback) {
        HttpClient.getInstance().post("Paidprogram.getPaidprogramClassList", MallHttpConsts.GET_PAY_CLASS_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void publishPayContent(
        ...
        HttpClient.getInstance().post("Paidprogram.addPaidProgram", MallHttpConsts.PUBLISH_PAY_CONTENT)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getMyPayContentList(int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.getMyPaidProgram", MallHttpConsts.GET_MY_PAY_CONTENT_LIST)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getBuyPayContentList(int p, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.getPaidProgramList", MallHttpConsts.GET_BUY_PAY_CONTENT_LIST)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getPayContentDetail(String goodsId, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Paidprogram.getPaidProgramInfo", MallHttpConsts.GET_PAY_CONTENT_DETAIL)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void searchGoodsList(String key, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.searchShopGoods", MallHttpConsts.SEARCH_GOODS_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("keywords", key)
                .params("p", p)
    ...
    public static void searchPayList(String key, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Paidprogram.searchPaidProgram", MallHttpConsts.SEARCH_PAY_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("keywords", key)
                .params("p", p)
    ...
    public static void buyPayContent(String goodsId, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("object_id=", goodsId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.balancePay", MallHttpConsts.BUY_PAY_CONTENT)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void commentPayContent(String goodsId, int starCount, HttpCallback callback) {
        ...
        String token = appConfig.getToken();
        String sign = MD5Util.getMD5(StringUtil.contact("object_id=", goodsId, "&time=", time, "&token=", token, "&uid=", uid, "&", SALT));
        HttpClient.getInstance().post("Paidprogram.setComment", MallHttpConsts.COMMENT_PAY_CONTENT)
                .params("uid", uid)
                .params("token", token)
                .params("time", time)
                .params("sign", sign)
    ...
    public static void getUserAuthInfo(HttpCallback callback) {
        HttpClient.getInstance().post("User.getAuthInfo", MallHttpConsts.GET_USER_AUTH_INFO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getOrderMsgList(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Message.getShopOrderList", MallHttpConsts.GET_ORDER_MSG_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
