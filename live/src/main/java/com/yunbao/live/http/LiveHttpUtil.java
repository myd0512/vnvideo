...
import com.yunbao.common.http.HttpRSAInterceptor;
...
public class LiveHttpUtil {
    ...
    public static void getUserList(String liveuid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.getUserLists", LiveHttpConsts.GET_USER_LIST)
    ...
    public static void roomCharge(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.roomCharge", LiveHttpConsts.ROOM_CHARGE)
    ...
    public static void timeCharge(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.timeCharge", LiveHttpConsts.TIME_CHARGE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("liveuid", liveUid)
    ...
    public static void getCoin(HttpCallback callback) {
        HttpClient.getInstance().post("Live.getCoin", LiveHttpConsts.GET_COIN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getLiveRecord(String touid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("User.getLiverecord", LiveHttpConsts.GET_LIVE_RECORD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .params("p", p)
                .execute(callback);
    ...
    public static void getAliCdnRecord(String recordId, HttpCallback callback) {
        HttpClient.getInstance().post("User.getAliCdnRecord", LiveHttpConsts.GET_ALI_CDN_RECORD)
                .params("id", recordId)
                .execute(callback);
    }
    ...
    public static void getAllImpress(String touid, HttpCallback callback) {
        HttpClient.getInstance().post("User.GetUserLabel", LiveHttpConsts.GET_ALL_IMPRESS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .execute(callback);
    }
    ...
    public static void setImpress(String touid, String ImpressIDs, HttpCallback callback) {
        HttpClient.getInstance().post("User.setUserLabel", LiveHttpConsts.SET_IMPRESS)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
    ...
    public static void getAdminList(String liveUid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.getAdminList", LiveHttpConsts.GET_ADMIN_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .execute(callback);
    ...
    public static void setAdmin(String liveUid, String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.setAdmin", LiveHttpConsts.SET_ADMIN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", touid)
    ...
    public static void getLiveShutUpList(String liveUid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Livemanage.getShutList", LiveHttpConsts.GET_LIVE_SHUT_UP_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("p", p)
    ...
    public static void liveCancelShutUp(String liveUid, String toUid, HttpCallback callback) {
        HttpClient.getInstance().post("Livemanage.cancelShut", LiveHttpConsts.LIVE_CANCEL_SHUT_UP)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", toUid)
    ...
    public static void getLiveBlackList(String liveUid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Livemanage.getKickList", LiveHttpConsts.GET_LIVE_BLACK_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("p", p)
    ...
    public static void liveCancelBlack(String liveUid, String toUid, HttpCallback callback) {
        HttpClient.getInstance().post("Livemanage.cancelKick", LiveHttpConsts.LIVE_CANCEL_BLACK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", toUid)
    ...
    public static void getLiveEndInfo(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.stopInfo", LiveHttpConsts.GET_LIVE_END_INFO)
                .params("stream", stream)
                .execute(callback);
    }
    ...
    public static void getLiveReportList(HttpCallback callback) {
        HttpClient.getInstance().post("Live.getReportClass", LiveHttpConsts.GET_LIVE_REPORT_LIST)
                .execute(callback);
    }
    ...
    public static void setReport(String touid, String content, HttpCallback callback) {
        HttpClient.getInstance().post("Live.setReport", LiveHttpConsts.SET_REPORT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("touid", touid)
    ...
    public static void getLiveUser(String touid, String liveUid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.getPop", LiveHttpConsts.GET_LIVE_USER)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("touid", touid)
                .params("liveuid", liveUid)
                .execute(callback);
    ...
    public static void kicking(String liveUid, String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.kicking", LiveHttpConsts.KICKING)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("touid", touid)
    ...
    public static void setShutUp(String liveUid, String stream, int type, String touid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.setShutUp", LiveHttpConsts.SET_SHUT_UP)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void superCloseRoom(String liveUid, int type, HttpCallback callback) {
        HttpClient.getInstance().post("Live.superStopRoom", LiveHttpConsts.SUPER_CLOSE_ROOM)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("type", type)
    ...
    public static void getGuardBuyList(HttpCallback callback) {
        HttpClient.getInstance().post("Guard.getList", LiveHttpConsts.GET_GUARD_BUY_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void buyGuard(String liveUid, String stream, int guardId, HttpCallback callback) {
        HttpClient.getInstance().post("Guard.BuyGuard", LiveHttpConsts.BUY_GUARD)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void getGuardList(String liveUid, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Guard.GetGuardList", LiveHttpConsts.GET_GUARD_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("p", p)
    ...
    public static void getLinkMicStream(HttpCallback callback) {
        HttpClient.getInstance().post("Linkmic.RequestLVBAddrForLinkMic", LiveHttpConsts.GET_LINK_MIC_STREAM)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void linkMicShowVideo(String touid, String pull_url) {
        HttpClient.getInstance().post("Live.showVideo", LiveHttpConsts.LINK_MIC_SHOW_VIDEO)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void setLinkMicEnable(boolean linkMicEnable, HttpCallback callback) {
        HttpClient.getInstance().post("Linkmic.setMic", LiveHttpConsts.SET_LINK_MIC_ENABLE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void checkLinkMicEnable(String liveUid, HttpCallback callback) {
        HttpClient.getInstance().post("Linkmic.isMic", LiveHttpConsts.CHECK_LINK_MIC_ENABLE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("liveuid", liveUid)
                .execute(callback);
    }
    ...
    public static void livePkCheckLive(String liveUid, String stream, String uidStream, HttpCallback callback) {
        HttpClient.getInstance().post("Livepk.checkLive", LiveHttpConsts.LIVE_PK_CHECK_LIVE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void sendRedPack(String stream, String coin, String count, String title, int type, int sendType, HttpCallback callback) {
        HttpClient.getInstance().post("Red.SendRed", LiveHttpConsts.SEND_RED_PACK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("coin", coin)
    ...
    public static void getRedPackList(String stream, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Red.GetRedList", LiveHttpConsts.GET_RED_PACK_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("sign", sign)
    ...
    public static void robRedPack(String stream, int redPackId, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Red.RobRed", LiveHttpConsts.ROB_RED_PACK)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
    ...
    public static void getRedPackResult(String stream, int redPackId, HttpCallback callback) {
        ...
        HttpClient.getInstance().post("Red.GetRedRobList", LiveHttpConsts.GET_RED_PACK_RESULT)
                .params("uid", uid)
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("redid", redPackId)
    ...
    public static void sendDanmu(String content, String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.sendBarrage", LiveHttpConsts.SEND_DANMU)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void checkLive(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.checkLive", LiveHttpConsts.CHECK_LIVE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void getQrCode(HttpCallback callback) {
        HttpClient.getInstance().post("Agent.getCode", "110")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void enterRoom(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.enterRoom", LiveHttpConsts.ENTER_ROOM)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void getGiftList(HttpCallback callback) {
        HttpClient.getInstance().post("Live.getGiftList", LiveHttpConsts.GET_GIFT_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void sendGift(String liveUid, String stream, int giftId, String giftCount, int ispack, int is_sticker, HttpCallback callback) {
        HttpClient.getInstance().post("Live.sendGift", LiveHttpConsts.SEND_GIFT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void livePkSearchAnchor(String key, int p, HttpCallback callback) {
        HttpClient.getInstance().post("Livepk.Search", LiveHttpConsts.LIVE_PK_SEARCH_ANCHOR)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("key", key)
                .params("p", p)
                .execute(callback);
    ...
    public static void getLivePkList(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Livepk.GetLiveList", LiveHttpConsts.GET_LIVE_PK_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void searchMusic(String key, HttpCallback callback) {
        HttpClient.getInstance().post("Livemusic.searchMusic", LiveHttpConsts.SEARCH_MUSIC)
                .params("key", key)
                .execute(callback);
    }
    ...
    public static void getMusicUrl(String musicId, HttpCallback callback) {
        HttpClient.getInstance().post("Livemusic.getDownurl", LiveHttpConsts.GET_MUSIC_URL)
    ...
    public static void createRoom(String title, int liveClassId, int type, String typeVal, int isShop, File file, boolean openLocation, HttpCallback callback) {
        ...
        params.put("token", appConfig.getToken());
        params.put("user_nicename", u.getUserNiceName());
        params.put("avatar", u.getAvatar());
        params.put("avatar_thumb", u.getAvatarThumb());
        params.put("city", openLocation ? appConfig.getCity() : "");
        params.put("province", openLocation ? appConfig.getProvince() : "");
        params.put("lat", openLocation ? String.valueOf(appConfig.getLat()) : "");
        params.put("lng", openLocation ? String.valueOf(appConfig.getLng()) : "");
        params.put("title", title);
        params.put("liveclassid", String.valueOf(liveClassId));
        params.put("type", String.valueOf(type));
        params.put("type_val", typeVal);
        params.put("isshop", String.valueOf(isShop));
        params.put("deviceinfo", LiveConfig.getSystemParams());

        String datastring = HttpRSAInterceptor.encryptParams(params);
...
//                .params("deviceinfo", LiveConfig.getSystemParams());
    ...
    public static void changeLive(String stream) {
        HttpClient.getInstance().post("Live.changeLive", LiveHttpConsts.CHANGE_LIVE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("status", "1")
    ...
    public static void stopLive(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.stopRoom", LiveHttpConsts.STOP_LIVE)
                .params("stream", stream)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    ...
    public static void getLiveSdk(HttpCallback callback) {
        HttpClient.getInstance().post("Live.getSDK", LiveHttpConsts.GET_LIVE_SDK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .execute(callback);
    }
    ...
    public static void getTxLinkMicAccUrl(String originStreamUrl, HttpCallback callback) {
        HttpClient.getInstance().post("Linkmic.RequestPlayUrlWithSignForLinkMic", LiveHttpConsts.GET_TX_LINK_MIC_ACC_URL)
                .params("uid", CommonAppConfig.getInstance().getUid())
    ...
    public static void getMyAdminRoomList(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Livemanage.GetRoomList", LiveHttpConsts.GET_MY_ADMIN_ROOM_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void getLiveGiftPrizePool(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Jackpot.GetJackpot", LiveHttpConsts.GET_LIVE_GIFT_PRIZE_POOL)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void anchorCheckLive(String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Live.checkLiveing", LiveHttpConsts.ANCHOR_CHECK_LIVE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("liveuid", liveUid)
                .params("stream", stream)
    ...
    public static void getLiveInfo(String liveUid, HttpCallback callback) {
        HttpClient.getInstance().post("Live.getLiveInfo", LiveHttpConsts.GET_LIVE_INFO)
                .params("liveuid", liveUid)
                .execute(callback);
    }
    ...
    public static void getTurntable(HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.GetTurntable", LiveHttpConsts.GET_TURN_TABLE)
                .execute(callback);
    }
    ...
    public static void turn(String id, String liveUid, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.Turn", LiveHttpConsts.TURN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("id", id)
                .params("stream", stream)
    ...
    public static void getTurnRecord(int p, HttpCallback callback) {
        HttpClient.getInstance().post("Turntable.GetWin", LiveHttpConsts.GET_WIN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .execute(callback);
    ...
    public static void getBackpack(HttpCallback callback) {
        HttpClient.getInstance().post("Backpack.getBackpack", LiveHttpConsts.GET_BACK_PACK)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
    ...
    public static void getSale(int p, String liveUid, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.GetSale", LiveHttpConsts.GET_SALE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("p", p)
                .params("liveuid", liveUid)
    ...
    public static void shopSetSale(String goodsid, int issale, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.SetSale", LiveHttpConsts.SET_SALE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void searchLiveGoodsList(int p, String keyword, HttpCallback callback) {
        HttpClient.getInstance().post("Shop.searchShopGoods", LiveHttpConsts.SEARCH_LIVE_GOODS_LIST)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
     ...
     * 获取游戏种类
     */
    public static void getTouziTypeList( HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.GetGameList", "Fastk3.GetGameList")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 购买
     */
    public static void buyticket(String stream,String batch,String param,HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.Buyticket", "Fastk3.Buyticket")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .params("batch", batch)
     ...
     * Draw
     */
    public static void fastk3Draw( String batch,String jmreq,HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.Draw", "Fastk3.Draw")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("batch", batch)
                .params("jmreq", jmreq)
     ...
     * 获取最新
     */
    public static void fastk3Getbatch( HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.Getbatch", "Fastk3.Getbatch")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 获取最新Drawlist
     */
    public static void fastk3Drawlist( HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.Drawlist", "Fastk3.Drawlist")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 获取最新Drawlist
     */
    public static void fastk3Myorder( HttpCallback callback) {
        HttpClient.getInstance().post("Fastk3.Myorder", "Fastk3.Myorder")
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
