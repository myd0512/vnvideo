...
public class CommonAppConfig {
    ...
    // RSA服务端公钥
    public static final String RSA_PUBLIC_KEY = getMetaDataString("RSA_PUBLIC_KEY");
    // RSA客户端私钥
    public static final String RSA_PRIVATE_KEY = getMetaDataString("RSA_PRIVATE_KEY");
    //外部sd卡
    ...
    //控制是否vip限制功能
    public static boolean ONLY_VIP = false;
    ...
    public String getAppName() {
        if (TextUtils.isEmpty(mAppName)) {
            int res = CommonAppContext.sInstance.getResources().getIdentifier("app_name", "string", "com.weilan.video");
    ...
    public int getAppIconRes() {
        if (mAppIconRes == 0) {
            mAppIconRes = CommonAppContext.sInstance.getResources().getIdentifier("ic_launcher", "mipmap", "com.weilan.video");
        }
        return mAppIconRes;
    }
    ...
    public String getAFKey() {
        String afKey = getMetaDataString("AF_DEV_KEY");
        return afKey;
    }
