...
public class Constants {
    ...
    public static final String PAY_TYPE_H5_1 = "h51";
    public static final String PAY_TYPE_H5_2 = "h52";
    public static final String PAY_TYPE_H5_3 = "h53";
    public static final String PAY_TYPE_H5_4 = "h54";
    public static final String PAY_TYPE_H5_5 = "h55";
    ...
    public static final String PAY_BUY_COIN_H5 = "Charge.getH5Order";
    ...
    //提现账号类型，1momopay，2zalopay ，3bankpay
    ...
    public static final String LIVE_PREVIEW = "livePreviewTime";
