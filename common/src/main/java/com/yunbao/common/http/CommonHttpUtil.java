...
public class CommonHttpUtil {
    ...
    public static void getConfig(final CommonCallback<ConfigBean> commonCallback) {
        HttpClient.getInstance().post("Home.getConfig", CommonHttpConsts.GET_CONFIG)
...
//                                LogUtil.elong("ja->",obj.toString());
    ...
    public static void getBalance(HttpCallback callback) {
        HttpClient.getInstance().post("User.getBalance", CommonHttpConsts.GET_BALANCE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("type", 0)
                .execute(callback);
    ...
    public static void getH5Order(String parmas, HttpCallback callback) {
        HttpClient.getInstance().post(parmas, CommonHttpConsts.GET_H5_ORDER)
                .execute(callback);
    }
    ...
    public static void checkTokenInvalid() {
        HttpClient.getInstance().post("User.ifToken", CommonHttpConsts.CHECK_TOKEN_INVALID)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(NO_CALLBACK);
    }
    ...
    public static void getUploadQiNiuToken(HttpCallback callback) {
        HttpClient.getInstance().post("Video.getQiniuToken", CommonHttpConsts.GET_UPLOAD_QI_NIU_TOKEN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
     ...
     * 上传文件 传到自己服务器
     */
    public static void upfiles(String host, File file, HttpCallback callback) {
        // 有文件，参数加密特殊处理
        ...
        HttpClient.getInstance().postFile(host, "Video.upfiles", CommonHttpConsts.UPFILES)
                .isMultipart(true)
...
//                .params("token", CommonAppConfig.getInstance().getToken())
    ...
    public static void setDistribut(String code, HttpCallback callback) {
        HttpClient.getInstance().post("User.setDistribut", CommonHttpConsts.SET_DISTRIBUT)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("code", code)
                .execute(callback);
