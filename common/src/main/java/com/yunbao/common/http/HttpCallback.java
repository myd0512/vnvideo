...
public abstract class HttpCallback extends AbsCallback<JsonBean> {
        ...
        if (bean != null) {
            if (200 == bean.getRet()) {
                ...
                if (data != null) {
                    ...
                    L.e("服务器返回值异常47--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
                }
            } else {
                L.e("服务器返回值异常50--->ret: " + bean.getRet() + " msg: " + bean.getMsg());
            }

        } else {
            L.e("服务器返回值异常54--->bean = null");
        }
    }
    ...
    public void onError(Response<JsonBean> response) {
        ...
        LogUtil.elong("网络请求错误---->" , t.getClass() + " : "+t.getMessage());
