...
public class LanguageUtils {
    ...
    public static void applyAppLanguage(@NonNull Activity activity) {
        ...
        updateLanguage(CommonAppContext.sInstance, appLocale);
    ...
    private static String getPrefAppLocaleLanguage() {
        SharedPreferences sp = CommonAppContext.sInstance.getSharedPreferences("I18N", Context.MODE_PRIVATE);
    ...
    public static String getAppLanguage() {
        Locale locale = CommonAppContext.sInstance.getResources().getConfiguration().locale;
