...
public class PayPresenter {
    ...
    public void pay(String payType, String money, String goodsName, String orderParams) {
        ...
        switch (payType) {
            ...
            case Constants.PAY_TYPE_H5_1:
            case Constants.PAY_TYPE_H5_2:
            case Constants.PAY_TYPE_H5_3:
            case Constants.PAY_TYPE_H5_4:
            case Constants.PAY_TYPE_H5_5:
                h5Pay(orderParams);
                break;
            default:h5Pay(orderParams);
        }
    }

    private void h5Pay(String orderParams) {
        orderParams = StringUtil.contact(mServiceNameH5, orderParams);
        CommonHttpUtil.getH5Order(orderParams, new HttpCallback() {
            @Override
...
//                    intent.setData(Uri.parse(url));
    ...
    public void setServiceNameH5(String serviceNameH5) {
        mServiceNameH5 = serviceNameH5;
    }
}
