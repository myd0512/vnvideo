...
public class GameHttpUtil {
    ...
    public static void gameJinhuaCreate(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Jinhua", GameHttpConsts.GAME_JINHUA_CREATE)
    ...
    public static void gameJinhuaBet(String gameid, int coin, int grade, HttpCallback callback) {
        HttpClient.getInstance().post("Game.JinhuaBet", GameHttpConsts.GAME_JINHUA_BET)
    ...
    public static void gameSettle(String gameid, HttpCallback callback) {
        HttpClient.getInstance().post("Game.settleGame", GameHttpConsts.GAME_SETTLE)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("gameid", gameid)
                .execute(callback);
    }
    ...
    public static void gameHaidaoCreate(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Taurus", GameHttpConsts.GAME_HAIDAO_CREATE)
                .params("liveuid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void gameHaidaoBet(String gameid, int coin, int grade, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Taurus_Bet", GameHttpConsts.GAME_HAIDAO_BET)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("gameid", gameid)
                .params("coin", coin)
    ...
    public static void gameLuckPanCreate(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Dial", GameHttpConsts.GAME_LUCK_PAN_CREATE)
                .params("liveuid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void gameLuckPanBet(String gameid, int coin, int grade, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Dial_Bet", GameHttpConsts.GAME_LUCK_PAN_BET)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("gameid", gameid)
                .params("coin", coin)
    ...
    public static void gameNiuzaiCreate(String stream, String bankerid, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Cowboy", GameHttpConsts.GAME_NIUZAI_CREATE)
                .params("liveuid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
    ...
    public static void gameNiuzaiBet(String gameid, int coin, int grade, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Cowboy_Bet", GameHttpConsts.GAME_NIUZAI_BET)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("gameid", gameid)
                .params("coin", coin)
    ...
    public static void gameNiuRecord(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.getGameRecord", GameHttpConsts.GAME_NIU_RECORD)
                .params("action", "4")
                .params("stream", stream)
                .execute(callback);
    }
    ...
    public static void gameNiuBankerWater(String bankerId, String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.getBankerProfit", GameHttpConsts.GAME_NIU_BANKER_WATER)
                .params("bankerid", bankerId)
                .params("stream", stream)
                .execute(callback);
    }
    ...
    public static void gameNiuGetBanker(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.getBanker", GameHttpConsts.GAME_NIU_GET_BANKER)
                .params("stream", stream)
                .execute(callback);
    }
    ...
    public static void gameNiuSetBanker(String stream, String deposit, HttpCallback callback) {
        HttpClient.getInstance().post("Game.setBanker", GameHttpConsts.GAME_NIU_SET_BANKER)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
    ...
    public static void gameNiuQuitBanker(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.quietBanker", GameHttpConsts.GAME_NIU_QUIT_BANKER)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void gameEbbCreate(String stream, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Cowry", GameHttpConsts.GAME_EBB_CREATE)
                .params("liveuid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("stream", stream)
                .execute(callback);
    ...
    public static void gameEbbBet(String gameid, int coin, int grade, HttpCallback callback) {
        HttpClient.getInstance().post("Game.Cowry_Bet", GameHttpConsts.GAME_EBB_BET)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .params("gameid", gameid)
                .params("coin", coin)
    ...
    public static void getCoin(HttpCallback callback) {
        HttpClient.getInstance().post("Live.getCoin", GameHttpConsts.GET_COIN)
                .params("uid", CommonAppConfig.getInstance().getUid())
                .params("token", CommonAppConfig.getInstance().getToken())
                .execute(callback);
    }
